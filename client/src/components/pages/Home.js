...
class Home extends Component {
  constructor(props) {
    ...
    this.whatThatMeanClicked = this.whatThatMeanClicked.bind(this);
  }
  whatThatMeanClicked() {
    window.location.href = "#whats-unifood-section";
  }
  ...
  render() {
    return (
      <div ref={this.ref} id="home-container">
        {/* Header Component */}
        <Header
        ...
        <section id="intro-section">
          ...
          >
            ...
            <path
              ...
              fill="#ff6348"
            />
            <circle cx="506.90154" cy="434.82862" r="1.24453" fill="#ff6348" />
            <circle cx="503.41686" cy="446.27828" r="1.24453" fill="#fff" />
            <circle cx="509.8884" cy="437.81549" r="0.74672" fill="#ff6348" />
            <circle cx="512.87527" cy="452.00311" r="0.74672" fill="#fff" />
            <circle cx="507.64825" cy="452.74983" r="0.74672" fill="#fff" />
            <circle cx="522.83149" cy="427.85927" r="0.74672" fill="#ff6348" />
            <path
            ...
            <path
              ...
              fill="#ff6348"
            />
            <circle cx="565.27997" cy="394.3629" r="1.24453" fill="#ff6348" />
            <circle cx="561.79529" cy="405.81255" r="1.24453" fill="#fff" />
            <circle cx="568.26683" cy="397.34976" r="0.74672" fill="#ff6348" />
            <circle cx="571.2537" cy="411.53738" r="0.74672" fill="#fff" />
            <circle cx="566.02668" cy="412.2841" r="0.74672" fill="#fff" />
            <circle cx="581.20992" cy="387.39354" r="0.74672" fill="#ff6348" />
          </svg>
          <div id="welcoming-container">
            <span id="welcoming-title">All restaurants in one place</span>
            <p id="welcoming-description">
              We offering a restaurant services for universities to make
              university life easier.
            </p>
            <DefaultButton
              text="What that mean?"
              size="large"
              onClick={this.whatThatMeanClicked}
            />
          </div>
        </section>
        <section id="whats-unifood-section">
          <span data-aos="zoom-in" data-aos-once="true" data-aos-duration="500">
            What's Unifood?
          </span>
          <p data-aos="zoom-in" data-aos-once="true" data-aos-duration="500">
            Unifood is a SASS (Software As Services) software offers a
            university restaurants service for any kind of universities.
          </p>
        </section>
        <section id="home-customer-section">
          <img
            src={CustomerIllImg}
            alt=""
            data-aos="fade-right"
          ...
          >
            ...
            <p>
              ...
              selecting the target product more efficiently, viewing the product
              page, ability to see the rating of the product to help you
              choosing and more other features!
            </p>
            <DefaultButton
              text="Read more&nbsp;&nbsp;"
        ...
        <section id="home-restaurant-section">
          <img
            src={RestaurantIllImg}
            alt=""
            data-aos="fade-left"
            data-aos-once="true"
            data-aos-duration="1000"
          ...
          >
            ...
            <p>
              We give the restaurant the ability to track their sales and orders
              to help them make decisions by showing you which products are less
              in demand to reconsider that product and more insights!
            </p>
            <DefaultButton
              text="Read more&nbsp;&nbsp;"
              iconClass="bi bi-box-arrow-up-right"
        ...
        <section id="home-university-section">
          <img
            src={UniversityIllImg}
            alt=""
            data-aos="fade-right"
            data-aos-once="true"
            data-aos-duration="1000"
        ...
        <section id="home-values-section">
          <p id="home-values-title">Values of our service</p>
          <div id="home-values-container">
            <HomeCard
              title="Relationships"
              description="Unifood can connects the restaurants, university, students and stuff together. provides the process of criticism."
              iconClass="bi bi-heart-fill"
            />
            <HomeCard
              title="Prevent gatherings"
              description="The main idea of our project is to reduce gatherings in the general areas especially in the last Covid 19 pandemic."
              iconClass="bi bi-people-fill"
            />
            <HomeCard
              title="Ease of use"
              description="Unifood provides an easy UI (User Interfaces) manipulated with a good UX (User Experience) to ensure nice distribution of elements on the screen."
